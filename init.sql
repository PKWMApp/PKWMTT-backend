...
--
-- Host: db
-- Generation Time: Lip 17, 2025 at 07:49 PM
...
CREATE TABLE `exams` (
  ...
  `date` date NOT NULL,
  `groups` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
...
(1, 'Matematyka Dyskretna', 'Egzamin końcowy z matematyki dyskretnej', '2025-07-30', '12K3,11L1', 2),
(2, 'Programowanie C++', 'Kolokwium z programowania w C++', '2025-08-05', '12K2,13S3', 1),
(3, 'Sieci Komputerowe', 'Projekt zespołowy na sieciach komputerowych', '2025-09-10', '14S4,12K1', 3);
...
INSERT INTO `groups` (`group_id`, `letter`, `group_count`, `general_group_id`) VALUES
(1, 'K', 1, 11),
(2, 'K', 2, 12),
(3, 'L', 1, 11),
(4, 'L', 2, 12),
...
INSERT INTO `otp_codes` (`otp_id`, `code`, `expire`, `used`, `user_id`) VALUES
(1, '123456', '2025-07-18 12:00:00', 0, 1),
(2, '654321', '2025-07-18 13:00:00', 0, 2),
(3, '111222', '2025-07-19 08:00:00', 1, 3);
