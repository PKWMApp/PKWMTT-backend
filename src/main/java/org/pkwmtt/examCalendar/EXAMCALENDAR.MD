...
RequestExamDto (`org.pkwmtt.examCalendar.dto.RequestExamDto`)
...
ResponseExamDto (`org.pkwmtt.examCalendar.dto.ResponseExamDto`)
...
Exam entity notes
- `org.pkwmtt.examCalendar.entity.Exam` stores:
