...
CREATE TABLE student_codes (
    otp_code_id INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE moderators (
    moderator_id BINARY(16) PRIMARY KEY,
...
CREATE TABLE user_refresh_token (
    ...
    CONSTRAINT fk_user_refresh_token_representative FOREIGN KEY (representative_id)
